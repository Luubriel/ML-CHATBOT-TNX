...
def responder(mensagem: str) -> str:
    ...
    # --- NOVAS PERGUNTAS SOBRE SAÚDE (Exercício 1) ---
    elif msg == "o que é diabetes":
        return (
            "Diabetes é uma doença crônica causada por excesso de glicose no sangue. "
            "Tipo 1: o pâncreas não produz insulina. "
            "Tipo 2: o corpo não usa a insulina de forma eficiente. "
            "Diagnóstico: glicemia em jejum ≥ 126 mg/dL em dois exames."
        )

    elif msg == "o que é sedentarismo":
        return (
            "Sedentarismo é a falta de atividade física regular. "
            "A OMS recomenda pelo menos 150 minutos de atividade moderada por semana. "
            "O sedentarismo aumenta o risco de diabetes, hipertensão e obesidade."
        )

    elif msg == "qual a importância da hidratação":
        return (
            "A hidratação adequada é essencial para o funcionamento do organismo. "
            "Recomenda-se beber entre 2 e 3 litros de água por dia. "
            "A desidratação pode causar tontura, fadiga e comprometer os rins."
        )

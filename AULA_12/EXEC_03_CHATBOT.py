...
def gerar_base_faq() -> pd.DataFrame:
    ...
    dados = [
        ...
        # ── SEDENTARISMO E TABAGISMO — Exercício 3 (5 novas perguntas) ──
        {
            "id": 41, "categoria": "estilo_vida", "intencao": "info_sedentarismo",
            "pergunta": "sedentarismo faz mal à saúde",
            "resposta": "Sim. O sedentarismo aumenta em até 35% o risco de doenças cardíacas, diabetes tipo 2 e alguns cânceres. A OMS recomenda 150 min de atividade moderada por semana."
        },
        {
            "id": 42, "categoria": "estilo_vida", "intencao": "info_sedentarismo",
            "pergunta": "quais exercícios são recomendados para iniciantes",
            "resposta": "Caminhada, natação e ciclismo são ótimos para iniciantes. Comece com 20–30 min, 3× por semana, e aumente gradualmente. Consulte um profissional de educação física."
        },
        {
            "id": 43, "categoria": "estilo_vida", "intencao": "info_tabagismo",
            "pergunta": "fumar aumenta o risco de infarto",
            "resposta": "Sim. Fumantes têm 2–4× mais risco de infarto. O tabagismo danifica as artérias, reduz o HDL e favorece a formação de coágulos. Parar de fumar reduz o risco já em 1 ano."
        },
        {
            "id": 44, "categoria": "estilo_vida", "intencao": "info_tabagismo",
            "pergunta": "quais doenças o cigarro causa",
            "resposta": "O cigarro causa: câncer de pulmão, laringe, boca e esôfago; DPOC; infarto; AVC; hipertensão; e doenças vasculares periféricas. Não há nível seguro de consumo."
        },
        {
            "id": 45, "categoria": "estilo_vida", "intencao": "info_tabagismo",
            "pergunta": "como parar de fumar",
            "resposta": "O SUS oferece tratamento gratuito para tabagismo: reposição de nicotina, medicação (vareniclina) e apoio psicológico. Ligue 136 para informações ou consulte sua UBS."
        },
    ]

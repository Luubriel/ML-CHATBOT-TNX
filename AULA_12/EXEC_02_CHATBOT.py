...
BASE_CONHECIMENTO = {
    ...
    "diabetes": {
        # Exercício 1 — nova intenção adicionada com 5 palavras-chave
        "keywords": ["diabetes", "diabético", "diabetico", "insulina",
                     "hiperglicemia", "tipo 2", "tipo 1"],
        "resposta": (
            "DIABETES:\n"
            "  • Tipo 1  : o pâncreas não produz insulina (autoimune)\n"
            "  • Tipo 2  : resistência à insulina (estilo de vida)\n"
            "  • Diagnóstico: glicemia em jejum ≥ 126 mg/dL (2 medidas)\n"
            "Dica: controle com dieta, exercício e, quando necessário, medicação."
        )
    },
